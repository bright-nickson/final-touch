  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.7s cubic-bezier(0.22,0.61,0.36,1) both",
        "fade-up": "fade-up 0.9s cubic-bezier(0.22,0.61,0.36,1) both",
        "scale-in": "scale-in 0.5s cubic-bezier(0.22,0.61,0.36,1) both",
        "slide-in-right": "slide-in-right 0.5s cubic-bezier(0.22,0.61,0.36,1)",
